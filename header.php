...
<div class="top-holder">
  ...
  <div class="toolbar-right" style="margin-right:30px;">
<ul>
   <!--<li  class="menu-item menu-item-type-custom menu-item-object-custom">
	<a  href="https://foxandfrank.com/wp-login.php">Login</a>
</li>-->
<li class="menu-item menu-item-type-custom menu-item-object-custom">
	<a  href="https://foxandfrank.com/store/cart">Shopping Cart</a>
</li>
</ul>
</div>
  <?php
