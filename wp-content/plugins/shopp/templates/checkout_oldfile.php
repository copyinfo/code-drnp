...
<form action="<?php shopp('checkout','url'); ?>" method="post" class="contact-form commentsblock" id="checkout">
...
<?php if (shopp('cart','hasitems')): ?>
	<?php shopp('checkout','function'); ?>
		...
		<div>
			...
			<div><?php shopp('checkout','firstname','required=true&minlength=2&size=8&title='.__('First Name','Shopp')); ?><label for="firstname"><?php _e('First','Shopp'); ?></label></div>
			<div>
		...
		<li></li>
		<li>
		<div class="inline"><label for="marketing"><?php shopp('checkout','marketing'); ?> <?php _e('Yes, I would like to receive e-mail updates and special offers343423!','Shopp'); ?></label></div>
		</li>
	</ul>
