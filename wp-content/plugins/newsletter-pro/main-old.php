...
<div class="wrap">
    ...
    <form method="post" action="">
        ...
        <table class="form-table">
            ...
            <!--
            <tr valign="top">
                <th>Popup integration theme</th>
                <td>
                    <?php $nc->page_themes('popup'); ?><br />
        ...
        <tr>
            ...
            <td><?php $nc->yesno('smtp_enabled'); ?></td>
        </tr>
        <tr>
            <th>SMTP host/port</th>
            <td>
                host: <?php $nc->text('smtp_host', 30); ?>
                port: <?php $nc->text('smtp_port', 6); ?>
                <br />
        ...
        <tr>
            ...
            <td>
                user: <?php $nc->text('smtp_user', 30); ?>
                password: <?php $nc->text('smtp_pass', 30); ?>
                <br />
