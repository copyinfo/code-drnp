...
<div class="wrap">
    ...
    <?php $nc->init(); ?>
        ...
        <p>Even if you code the form manually, you must enable the fields you want to collect during subscription.</p>
        ...
        <p>
            Remeber that lists are not separate lists of users, they are options chose by subscriber and usually they refer
        ...
        <table class="form-table">
            <tr>
                <th>Follow up</th>
                <td>
                    <?php $nc->select('followup_status', $status); ?>
                    label: <?php $nc->text('followup'); ?>
                    <div class="hints">
                        Usually subscribers are not asked if they want to receive or not the follow up.
                    </div>
                </td>
            </tr>
            <tr>
                <th>Feed by mail</th>
                <td>
                    <?php $nc->select('feed_status', $status); ?>
                    label: <?php $nc->text('feed'); ?>
                </td>
            </tr>
        </table>
        <p class="submit"><?php $nc->button('save', 'Save'); ?> <?php $nc->button('reset', 'Reset to defaults'); ?></p>
